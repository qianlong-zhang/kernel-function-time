...
int main(int argc, char **argv)
{
	...
	//numa_bitmask_setbit(old_nodes, 0); //set old_nodes->maskp bit 1 = 0
	//numa_bitmask_setbit(new_nodes, 1); //set new_nodes->maskp bit 1 = 1
	//printf("old_nodes :0x%lx\n", *old_nodes->maskp);
	//printf("new_nodes :0x%lx\n", *new_nodes->maskp);
	...
	//malloc on node 1
	page_base = numa_alloc_onnode((pagesize + 1) * page_count, 0);
